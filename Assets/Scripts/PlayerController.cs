...
public class PlayerController : MonoBehaviour
{
    ...
    public float speed = 2.5f; // velociada de movimiento
    ...
    public float jumpForce = 5f; // fuerza de slato
    ...
    public float doubleJumpSpeed = 3.3f; // creamos una varible para la nueva fuerza  o no saltar doble salto
    ...
    public RectTransform retryMenu; // menu para reintentar
    ...
    void Update()
    {
        ...
        //aqui guardo los numeros que nos da el input de las flechas o A D
        float horizontal = Input.GetAxisRaw("Horizontal");

        //aqui guardo el movimeonto que esta realiznado 
        _movement = new Vector2(horizontal, 0);

        if(horizontal < 0f && _faceRight == true)
        {
        ...
        if(horizontal > 0f && _faceRight == false)
        {
    ...
    private void LateUpdate()
    {
        ...
        animator.SetBool("Run", _movement != Vector2.zero && _isGrounded && rigthFoot);
